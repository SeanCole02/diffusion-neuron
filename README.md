...
1. [Why this problem is hard](#why-this-problem-is-hard)
2. [Architecture](#architecture)
3. [Same Frame Encoding (SFE)](#same-frame-encoding-sfe)
4. [Setup](#setup)
5. [Running](#running)
6. [Training metrics](#training-metrics)
7. [Ablations and tuning](#ablations-and-tuning)
8. [Files](#files)
...
4. If real training SSIM drops significantly below the noise baseline, the decoder is too small; increase capacity
